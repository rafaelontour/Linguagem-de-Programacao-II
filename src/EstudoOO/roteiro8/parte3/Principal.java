...
public class Principal {
    public static void main(String[] args) {
        ...
        Cliente cliente = new Cliente("04357682510", "Rodolfo", "Rua 4", "rodolfo@gmail.com", "72999987764", v03);
        Cliente cliente02 = new Cliente("09357613540", "Arlindo", "Rua Branco Palmero", "arlindo@gmail.com", "74957987182", v02);
        Cliente cliente03 = new Cliente("05657713290", "Mauro", "Rua Velho Brás ", "mauroRJ@hotmail.com", "79957980061", v04);
        ...
        System.out.println("Tipo de veículo: " + cliente02.getVeiculo2().tipoVeiculo());
        System.out.println("Valor a ser pago no pedágio: R$" + cliente02.getVeiculo2().calcPedagio());
        System.out.println("********************************\n");
        ...
        System.out.println("Tipo de veículo: " + cliente03.getVeiculo3().tipoVeiculo());
        System.out.println("Valor a ser pago no pedágio: R$" + cliente03.getVeiculo3().calcPedagio());
        System.out.println("********************************\n");
